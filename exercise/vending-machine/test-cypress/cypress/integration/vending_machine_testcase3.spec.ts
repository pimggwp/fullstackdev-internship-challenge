...
describe('Test case 3', () => {
    ...
    it('Select product and get product', () => {
        ...
        cy.get('[class="animate title"]').should('not.exist');
        cy.get('[class="swal2-popup swal2-modal swal2-show"]').contains('Please insert more coins.')
        cy.get('[class="swal2-popup swal2-modal swal2-show"]').find('button').contains('OK').click()
    })
    it('Receive change', () => {
